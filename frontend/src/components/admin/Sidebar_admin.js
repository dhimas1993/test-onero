                        ...
                        <div class="row">
                            <nav class="col-md-2 col-xs-1 d-none d-md-block sidebar" style={{backgroundColor: "white"}}>
                                <div className="sidebar" style={{}}>
                                    ...
                                    <li class="nav-item" onClick={()=>{this.setState({menu:4})}}>
                                        <p className="btn btn-block btn-outline-primary my-4" href="#">
...
export default connect(mps) (Dashboard_admin)